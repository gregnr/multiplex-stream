import { collectFrames, concat } from '../util/frames';
import type { DuplexStream } from '../types';
import { fromReadable, toReadable } from '../util/async-iterator';
 ...
 *
 * Use this when the underlying transport does not guarantee whole
 * messages for every chunk, such as TCP streams or Yamux multiplexed
 * streams. If your underlying stream implements flow control,
 * you will likely need to frame your messages. Note that Web Sockets
 * incorporate framing into its protocol, so you do not need to add
 * additional framing unless you add another layer on top like Yamux.
 *
